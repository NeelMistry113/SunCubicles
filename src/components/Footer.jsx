...
export default function Footer() {
  return (
    <footer className="w-full bg-[#030213]">
      ...
      >
        {/* Top row */}
        <div className="flex gap-[72px] items-start w-full" style={{ flexWrap: 'wrap' }}>
          {/* Brand col */}
          <div className="flex flex-col gap-[16px] shrink-0" style={{ width: '280px' }}>
          ...
          {/* Links columns */}
          <div className="flex flex-1 justify-between gap-8" style={{ flexWrap: 'wrap', minWidth: 0 }}>
            {/* Quick Links */}
            <div className="flex flex-col gap-[16px]">
              <p
                className="text-white"
                style={{ fontFamily: 'Geist, Inter, sans-serif', fontSize: '18px', lineHeight: '1.3' }}
              >
                Quick Links
              </p>
